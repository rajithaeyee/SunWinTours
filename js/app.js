var app = angular.module("travelSriLanka", ['ui.bootstrap','ngFileUpload']);
/*
...
app.controller("TravelController", function ($scope, $http, $uibModal, $log, $document) {
...
*/
    ...
    $scope.ShowGallery = function ($scope) {
    ...
    $http.get(
        'php/readComments.php'
    ).then(function(result){
        $scope.allUserComments=result.data;
        console.log($scope.allUserComments);
